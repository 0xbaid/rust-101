...
fn main() {
    ...
    //since expensive_sum takes my_vector by value it becomes move closure by i have to call 
    //move explicitly
    ...
    //in result, you can see the main thread did not join the child thread until the main thread finished
    ...
    //unbounded means it can buffer values until it runs out of memory
