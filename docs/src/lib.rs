...
//! most often deep yellow to orange in coloration. The thick shell contains the seeds and pulp. The name
//! is most commonly used for cultivars of Cucurbita pepo, but some cultivars of Cucurbita maxima, C.
...
pub struct Pumpkin {
    ...
    pub roundness: f32,
    /// `orangness` is a number Big orange thing
    pub orangeness: i32,
}
